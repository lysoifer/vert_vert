...
write.csv(sp.vars, paste(savedatafolder,"mammals","_spvars.csv",sep=""))
...
write.csv(Realm.vars, paste(savedatafolder,"mammals_Realmvars.csv",sep = ""))
...
write.csv(biorealm.vars, paste(savedatafolder,"mammals_biorealmvars.csv",sep = ""))
```
...
# SAVE
```{r echo=F, eval=FALSE}
save.image(paste(savedatafolder,"mammals",'_data.RData',sep=""))
```